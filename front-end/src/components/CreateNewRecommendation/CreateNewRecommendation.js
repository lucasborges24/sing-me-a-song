...
export default function CreateNewRecommendation({ onCreateNewRecommendation = () => 0, disabled = false }) {
  ...
  return (
    <Container>
      ...
      <Input data-cy="Youtube" type="text" placeholder="https://youtu.be/..." value={link} onChange={e => setLink(e.target.value)} disabled={disabled} />
      <Button data-cy="Post-Recommendation-Button" onClick={() => handleCreateRecommendation()} disabled={disabled}>
